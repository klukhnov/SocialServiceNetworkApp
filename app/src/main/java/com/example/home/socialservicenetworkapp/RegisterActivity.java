...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CreateNewAccount() {
        ...
        if(TextUtils.isEmpty(email)){
            ...
            Toast.makeText(this, "Please set the password", Toast.LENGTH_LONG).show();
        } else if(TextUtils.isEmpty(confirmPassword)){
            Toast.makeText(this, "Please set the password confirmation", Toast.LENGTH_LONG).show();
        } else if(!password.equals(confirmPassword)){
            Toast.makeText(this, "Please set correct password confirmation", Toast.LENGTH_LONG).show();
        }else {
